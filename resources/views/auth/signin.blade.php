...
@section('content')
    ...
    <div class="container-reverse">
        <div class="signin-form">
            <div class="form-box">
                <h1 class="title">Entre na FlowGen</h1>
                ...
                <form action="{{ route('login.store') }}" method="POST">
                    ...
                    <p class="login-link">Não tem uma conta? <a href="#">Criar</a></p>
                </form>
            </div>
        </div>
        ...
        <div class="animation-in">
            ...
            <p class="non-gradient-text">Entre na sua conta para continuar criando conteúdos incríveis para o seu negócio.</p>
